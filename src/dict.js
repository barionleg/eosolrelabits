...
Mifami,Sigh,
Mifasol,"Raise, elevate, uplift, high",(Musical sense)
Mifala,"Desire, wish, want, desirous",
Mifasi,"Incorrigible, unable to be corrected",
Misoldo,The Holy Spirit,(Triad)
...
Solmire,"Verb, noun, adjective, adverb",(Irregular)
Solmifa,Article,(grammatic article?)
Solmisol,Pronoun,
...
Sollasi,"Climb, mount, rise, climbing, ascent",(musical sense)
Solsido,"Run, gallop, race, runner","Typo - entered as ""Sollado"""
...
Ladore,"College, high school, institution, university, teacher, professor, headmaster",How does one distinguish between the two senses of the noun?
Ladomi,"School, student, pupil, disciple",Same question as above
Ladofa,"Read, reading, reader, readable, legibly",
Ladosol,"Book, volume, tome",
Ladola,"Preface, foreword, preamble, introduction",
Ladosi,"Word, term","(Modernly ""password"" also)"
...
Larela,"Phrase, sentence","Typo - entered as ""Farela"""
Laresi,"Distraction, inattention, inadvertently, inattentive, carelessness, disapplied",
Lamido,"Temporary, fleeting",Not a great translation
Lamire,"Write, writing, writer",
Lamifa,Pen,"Typo - entered as ""Famifa"""
...
Lasolsi,"Draw, trace","(Also ""linear"" &c. … Probably supposed to be in Lasolla?)"
...
Sidosi,"Learn, learning, education, apprenticeship",(Also teaching?)
Siredo,"Grammar, syntax, grammatically",
Siremi,"Spell, spelling, orthography, orthographic",(See Laremi - redundancy)
Sirefa,"Accuracy, exactitude, punctuality, assiduity",
Siresol,"Regular, symmetric, symmetry, correct",
Sirela,"Attention, take care, contemplation, be careful",(opposite of Laresi)
...
Sifado,"Dictate, dictation, read out",(Say?)
...
Sifasi,"Reiterate, renew, again",(Redundant with Sifala)
Sisoldo,"Compete, contest",
Sisolre,"Encourage, embolden, stimulate",
Sisolmi,"Inspect, review, inspector, inspection",
Sisolfa,"Review, scrutinize, investigate",(Redundant with Sisolmi?)
Sisolla,"Analyze, analysis, analyst, analytical",(Redundant with Sisolmi?)
...
Silami,"Hate, detest, abhor, hatred, animosity, aversion",(Redundant - see Dolami. Silami makes more sense; it's the opposite of Milasi)
Silafa,"Unable, unfit, incapable, inept",
Silasol,"Down, descent, go down",(Redundant  - see Solfami)
...
Doredosol,"Hair, eyebrows, mustache, beard, eyelashes",Irregular? (Too many ideas?)
Doredola,Face,
Doredosi,Cheeks,
...
Doresolre,"Servant, maid, valet, chambermaid","(Also translated as house or domestic, but I think this is the right idea)"
Doresolmi,Stomach,
Doresolfa,"Abdomen, belly",(Redundant with Doresolmi?)
...
Doresifa,Chyle,(Maybe not necessary?)
Doresisol,"Blood, bloody",
Doresila,"Circulate, circulation","(Automatically defined as ""travel"" and ""traffic"", but I assumed from context that it meant more along the lines of the circulatory system)"
Domidore,Members,"(Maybe actually means ""body parts""?)"
Domidomi,"Thigh, knee",
Domidofa,"Leg, calf",
Domidosol,"Foot, heel",
...
Domisolsi,Soul,(Note - this whole family of ideas is derived from the perfect chord that represents God)
...
Domisire,"Pretend, claim, pretense","(Also as ""aspire"", but that doesn't seem to fall under the same idea)"
...
Dofamido,"Feelings, principles",(Principles??)
Dofamire,"Qualify, qualification, quality, attribute, qualifier",
Dofamifa,"Have virtue, virtue, virtuous, virtuously","(Not great translation on the first word - ""Avoir de l'empire sure méme)"
...
Dofalado,"Frankness, honesty, sincerity, frank, sincere, truly","(""Franchise"" and loyalty are also given - I think I got the main idea here)"
Dofalare,"Goodness, meekness, benignity",
Dofalami,"Sensitivity, impressionability, sensitive, impressionable",
Dofalafa,"Heartfelt, warmth, effusion, profusely","(Not great translation, but I think I got it)"
...
Dofasila,"Delicacy, tact, delicate, gently","(This one was really hard - the other definitions were based on the word ""scruples"")"
Dosoldore,"Appeal, evoke","(not very certain about this either… ""Appeler"" also means ""call"")"
...
Doladosol,Cover (noun),(Presumably also a verb &c.?)
Doladola,Table,
Doladosi,"Tablecloth, napkin",
Dolaredo,"Tableware, dishes, plate, dish, cup, vase",
Dolaremi,Fork; also slang: 'to be right',This is an original slang word developed by the modern Solresol community; it is the opposite of 'mirelado' - to be wrong.
...
Dolamire,"Water, wet",
Dolamifa,"Thirsty, thirst, parched","(Assumed from context (otherwise it was ""alter"")"
Dolamisol,"Drink, drinker",(Drinker possibly has a conotation of being drunk)
...
Dolafasi,"Fish, oysters, eels, salmon",(Seafood?)
...
Dolasolla,"Pastry, cake, meringue, pie","Typo - entered as ""Dolamila"""
Dolasolsi,"Pork, ham",(Delicatessen?)
...
Dolasila,Mustard,
Dosidore,"Suffice, sufficiency, sufficient, enough, necessary","Typo - ""Sufifre"" should be ""Suffire"""
...
Dosidola,"Juice, sauce, juicy",(Too many meanings?)
Dosidosi,"Eggs, egg shell, omelette",
Dosiredo,"Dairy, milk, cream, creamy, dairyman",
Dosiremi,Butter,
Dosirefa,Cheese,
Dosiresol,"Dessert, hazelnuts, nuts, almonds, chestnuts, walnuts",These three need some work. Two are redundant and one is contradictory.
...
Dosimire,"Pour, spill","Typo - entered as ""Dosimido"""
Dosimifa,Liquors,
Dosimisol,"Spirits, alcohol, brandy, rum, absinthe",Redundant
...
Dosisolsi,"Food, edible",Redundant?
Dosilado,"Fragment, cutting, piece, bit, slice",
Dosilare,"Empty, void, dry, blank",
Dosilami,"Appetizer, hors d'oeuvres","(""Entremets"" was defined as ""desserts"", but because of ""hors d'oeuvres"" and the ""entre"" I decided it was wrong)"
...
Redoresi,"Pants, knickers, breeches",(Also underpants?)
...
Redolado,"Toilet, toiletries, personal grooming, wash","Type - entered as ""Redolami"""
...
Remidomi,Depositary (Bank? Lockbox?),Not great translation
Remidofa,"Brooch, clasp, pin","Modernly ""Staples"""
...
Remiremi,"Walk, stroll, wander, promenade","Redundant? This word apparantly has a conotation of a more leisurely, public walk to meet/encounter other people (Promenade)"
...
Remisolmi,"Door, gate","Changed from 'post, gate' to 'door, gate' - 'post' is presumably a typo for French 'porte'"
...
Refadore,"Move in, install",(not sure on this one)
Refadomi,"Furniture, furnishings",(Redundant? Translation?)
Refadofa,Household,"(household chores, housework?)"
...
Refamido,"Die, pass away, death, mortality, fatally","Typo - Refamido through refamisi are all entered as Refaredo through refaresi. Also, I would posit that ""mortality"" shouldn't be in this definition"
Refamire,"Stove, radiator, furnace, oven","Typo - Entered as Refadore. Also, ""heater"" should be a different word from ""stove"""
...
Refasolla,"Chauffeur, driver","Translation - ""Chauffer"": heat; ""Chauffeur"": driver"
Refasolsi,"Hearth, fireplace, firebox","Translation - ""ashy"" and ""ashtray"""
Refalado,"Rag, dishtowel, apron, pillowcase, sheet",I dislike all these words in the same place
...
Refasifa,"Chisel, cut, carving, scissors","(very different, really)"
Refasisol,"Cut, knife, cutter, cutting, sharp",
Refasila,"Work, worker",
Resoldore,"Pouch, backpack, knapsack, bag",(pocket?)
...
Resolresi,"Remove, dismiss, removal, dismissal, resignation",(What is the intrinsic difference between this and resolresol?
...
Resollare,Undress,"(negligee? Neglected? ""Se déshabiller"", ""négligé"", ""déshabillé"")"
...
Resolsisol,"Book, work","Translation ""ouvrage"" and ""oeuvre"""
...
Relafare,"Bend, stoop, curvature, curve, bent","Translation: Possibly only of a person, ""to bend down""?"
...
Midoredo,"Moral, immateriality, spirituality, intangible, spiritualist, spiritualism",(Too many words?)
...
Midomifa,"Bequeath, to leave something for someone, testament",(Translation)
...
Midosolsi,"Fatalism, fatalist, inevitably",(Redundant?)
...
Midolasi,"Content, satisfied, contentment, satisfaction, joy of the heart, glad","(Translation - also ""enchanted"", ""charmed"")"
...
Midosifa,"To return, come back",(Goodbye?)
...
Miremifa,"Document, title, written evidence","(Too many words? (i.e. not ""title""))"
Miremisol,"Official, formal, officially",
Miremila,"Dedicate, dedication, dedicatory",
Miremisi,"Stanza, verse",(Categorization??)
...
Miresimi,"Slap, kick, punch",(translation)
Miresifa,"Hurt, wound, bruise","(Translation - I think this is what it means, though)"
...
Mifaredo,"Personality, personal","Translation - (Also ""égoïsme"" - selfishness)"
...
Mifamila,"Sensuality, intemperance, sensual, voluptuous, carnal",(probably negative connotation)
Mifamisi,"Gluttony, greedy, glutton, ""pig"", greedily",
Mifasoldo,"Libertine, prostitute, wantonness, prostitution, vagrant, debauchery",(Sexual immorality)
...
Misoldofa,"Annoy, tease, teasing, playfulness, harassing","(Redundant. Also translated as ""mutiny"", ""mutineer"")"
...
Misolredo,"Person, a being, individual, human creature, people, personal, individually, personally","Redundant for ""personally"" (Unless the other for ""dore"" is actually meant only for the person speaking, and this is like ""He personally thought…"")"
Misolremi,"Recommend, recommendation",
Misolrefa,"To present, presentation",
Misolresol,"Accept, receive, admit, admission, reception, admissible, receivable","(Host, welcome, hospitable?)"
Misolrela,"Meet, get together, meeting, group, assemble, assembled, grouped",
Misolresi,"Society, corporation, company, member of a society",(e.g. Freemasons)
...
Misolfare,"Attitude, poise, posture ",(How one holds oneself?)
Misolfami,"Turn (v.), pace (v.)",
Misolfasol,"Propriety, appropriateness, decency, proper, seemly, presentable",
Misolfala,"In good taste, good manners, distinction, distinguished","(Kind of redundant - maybe along the lines of ""fashionable""?)"
...
Misollare,"Capricious, whimsical, moody",(redundant? I can't remember)
Misollami,"Mania, maniac","Translation - also ""captious"" and ""meticulous"""
Misollafa,"Simper, pedantry, prudery, affected, prudish, pretentious",
Misollasol,"Coquet, dainty, pretty, to pose oneself, coquettishly",(Generally fake beauty/manners?)
Misollasi,"To woo, to court, courtship",
Misolsido,"Inaugurate, inaguration, inaugural",
Misolsire,"Celebrate, celebration, ceremony, ceremonial","(Translation - also ""solemnize"" and related words.)"
Misolsimi,"Holiday, anniversary",
Misolsifa,"Indirect, indirectly",
Misolsisol,"Ball (dance), ballet",
Misolsila,"Dance, dancer, dancing",
Miladore,"Waltz, waltzer","(Also ""polka"" but that doesn't make any sense)"
...
Milarefa,"Criticize, find fault with, criticism","(Translation - also ""censor"" and ""censorship"""
Milaresol,"To speak ill of, decry, depreciate, disparage, slander, detraction, disparagement, slanderous",
Milarela,"Slander, slanderer, slanderously",(Redundant - see milaresol)
...
Milamifa,"Confidential, confidence, confidant, confidentially",(in private)
Milamisol,"Snoop around, curiosity, curious, curiously",
Milamila,"Guess, to divine, diviner, guessable ","(maybe ""guesser"" more than ""diviner"")"
Milamisi,"Disclose, divulge, reveal, disclosure, unveiling, revelation, discloser, revealer",
Milafado,"Insensitivity, apathy, insensitive, apathetic",(covers too many ideas)
...
Milasolmi,"Defame, lampoon, libel, diatribe, slanderer","Redundant? Also - ""pamphleteer"""
Milasolfa,"Challenge, discuss, debate, object, controvert, obejection, controversy, conflict, questionable","""controversy"" and ""questionable"" seem like they don't quite fit in this word"
...
Milasimi,"Review, report, extract, essence of","(I guess this is a suitable definition. French ""Notice"" and ""Extrait"")"
...
Misisolla,"Believe, imagine, credulity, credulous","(Perhaps more toward the end of believing to a fault - gullibility, etc.)"
...
Misilafa,"Bewitch, cast a spell on someone, sorcery, witchcraft, sorcerer, magician, enchanting, magic","(Presumably not redundant with ""misilado"". A magician in that sense would perhaps be one who simply does tricks? And this one is a real one)"
Misilasol,"Partner, accomplice","Translation - ""compérage"""
Misilasi,"Colusion, accomplice (in crime?), (accessory)","(Presumably not redundant with misilasol - this word seems to be an accomplice in a negative, criminal sense)"
...
Fadoresol,"Picturesque, rugged",(Rugged? Really?)
...
Fadofasol,"Tree, shrub, bush",(too many meanings)
...
Fadosolmi,"Mow, reap, trim","(maybe not ""reap"")"
...
Fadolasi,"Hedge, bush, undergrowth","(thorny, thorns?)"
Fadosido,"Garden (v.), gardening, horticulture, gardener, horticulturist",
Fadosire,"Garden (n.), grove",
Fadosimi,"Bloom, flower (v.), blossom, florist, floral",(florist doesn't seem to fit)
Fadosifa,"Bouquet, flower-seller",(use florist here?)
...
Faremila,Ear (of wheat/corn),Is this word necessary?
Faremisi,"Field, meadow, prairie, plain, pastoral",(Rural?)
...
Faresolre,"Bridle, reins, bit",Is all this horse talk really necessary?
Faresolmi,"Saddle, saddler",
Faresolfa,Stirrup,
Faresolla,"Whip, crop",
Faresolsi,Harness,
Farelado,"Animal, quadroped",
Farelare,"Sheep, lamb",Categorization: These six animals should really be in the five-syllable section
Farelami,"Cattle, cow, bull, beef",Categorization
Farelafa,"Pig, pork, sow, boar",Categorization
Farelasol,"Goat, kid",Categorization
Farelasi,"Donkey, ass",Categorization
Faresido,Camel,Categorization
Faresire,"Dog, bitch",
Faresimi,Cat,
Faresifa,Bird,
...
Famidomi,"Soldier, corporal, brigadier, sergeant, sergeant major, warrant officer, noncommissioned officer",(how does one tell the difference between all these words?)
Famidofa,Uniform,"Also ""helmet"" and ""tunic"", but those need their own words"
Famidosol,"Equipment, pouch, belt, shoulder strap, harness, knapsack (backpack)",WAY too broad
Famidola,"To arm, arms, weapons, weapon maker, armor",Broad - armor doesn't fit
Famidosi,"To increase gradually (graduate), grade, degree, rank, gradual, gradually",This doesn't totally make sense.
...
Famifala,"Regiment, legion, battalion, squadron, company",Redundant? Is there a real difference between this and Famifasol?
Famifasi,"Zouaves, Spahis (both are members of infantry/cavalry in France) ",Unnecessary
Famisoldo,"To kill, to ""off"", killed","Translation - ""amortize"", ""deaden"""
Famisolre,"Infantry, rifleman, infantryman, grenadier, ""outfielder""",
Famisolmi,"Cavalry, cavalryman","Translation - also ""dragon"", ""lancer"", ""hunter"""
...
Familare,Tent,
Familami,Bivouac,"(Redundant? ""camp"" is already a word  - Familado)"
Familafa,"Itinerant, travelling","Translation - (Also ""ambulance"")"
...
Famisisol,"Translation issues, but I'm guessing: a synchronized firing of guns","MAJOR translation issues. ""Crosse ou Culasse / Batterie de fusil / Canon de fusil / Baïonnette"
...
Fasolrela,"Fire, unload, release, shooting, rifleman",Redundant
...
Fasolfasol,"Conquer, conquest, feat, conqueror",Partially redundant with fasolfami
Fasolfala,"Heroism, heroes, hero, heroin, heroic",
Fasolfasi,"Triumph, victory, victor, triumphant, triumphal","Redundant? I feel that this word, Fasolfasol, and Fasolfami could be combined to one or two words."
...
Faladomi,"Space, expanse, area, spacious, expansive",(Latitude?)
Faladofa,Kilometer,(League)
Faladosol,"Row (v), oar, rowing, rower, oarsman",
Faladola,To sail (v.),
Faladosi,"Maneuver, one who maneuvers","(Translation: ""évolution"", operate, worker?)"
Falaredo,"To board, access, dock, boardable, accessible","(Also to dock, to land, to come along side (of land)?)"
Falaremi,"To anchor, to moor, anchor, mooring",
Falarefa,"Seaport, harbor",
Falaresol,"Beach, shore, bank",
Falarela,"Coast, seashore, sea-cliff","(Redundant? Translation? ""Cote"", ""Falaise"", Littoral"")"
Falaresi,"Strait, peninsula, isthmus",(Archipelago? Isle?)
Falamido,"Madness, insanity, dementia, crazy, insane",
Falamire,"Lake, lagoon, pond",
Falamifa,"Depth, deep, deeply",(Profound)
Falamisol,"To fish, fishing, fisherman",
Falamila,Fishing line,
Falamisi,"Bait, lure, fishhook",
Falafado,"Swim, swimmer, by swimming",(Fin?)
...
Falasolre,"Channel, canal, conduit",(Pipeline)
...
Solremido,"Perform, performance, performer, performing","""Executive""?"
...
Solremisi,"Soprano, Mezzo-soprano, mezzo-contralto, contralto",Possibly a translation problem.
Solrefado,"Vocalize, vocalization, vocalized","Translation - ""Roulade""?"
...
Solrelare,"Wonder, marvel, be struck by, stupefaction, surprised, amazed, stunned, struck, shocked",Clearly some subtle differences between this word and Solrelado that could be made clearer by someone who knows French better
Solrelami,"Fascinate, mesmerize, enchant, delight, excite, inspire, fascination, prestige, fascinating","Translation - ""transport""?"
Solrelafa,"Feel, experience, to start (with surprise etc.), impression, feeling, emotion, stir, thrill, impressed, moved, affected, shuddering, trembling",Vague
Solrelasol,"To get excited, get enthusiastic, enthusiasm, excitement, enthusiastic, excited",
Solrelasi,"Irresistible, irresistibly",
Solresido,"Captivate, enthrall, fascinate, subjugate, submit","Submit doesnt seem to fit... maybe ""bring under submission"" in a metaphorical, enthralling kind of way?"
...
Solmiredo,Acoustic,
Solmiremi,Tuning fork,Translation - Diapason? Concert pitch?
Solmirefa,"Tone, tonality, tonic",
Solmiresol,"Sharp (as in music, ""C Sharp"")",Chromatic?
Solmirela,"Flat (as in music, ""B Flat"")",Chromatic?
...
Solmifare,Half step (Leading tone?),This translation was sketchy - I'm not sure this is correct; it needs someone else to look at it
Solmifami,"Interval, gap",
Solmifasol,"Interval of a tone, semitone, half step",Translation problems here too
Solmifala,"Major key, major mode",Opposite is minor key
...
Solmilasi,"Keyboard (on a piano), key, pedal",Pedal doesn't fit - vague definition
...
Solfadore,Philotechnic?,Translation! Not at all sure what this means or is supposed to mean
Solfadomi,"Philharmonic, philharmonic society (Devoted to music)",
Solfadofa,Choirmaster,
Solfadosol,"Choir, singer, choir member, chorus, in chorus","Translation - ""choryphée""?"
Solfadola,"Choral society, a member of a choral society",Is this word necessary?
...
Solfaredo,Concerto,
Solfaremi,"Cavatina (""A short operatic aria in simple style without repeated sections"")",Necessary? Most people wouldn't use this word in normal speech.
Solfarefa,"Solo, duo, trio, quartet, quintet",Are these distinguished through accentuation? That doesn't seem clear or logical. I would say this definition is vague.
Solfaresol,"Portamento (""A slide from one note to another, esp. in singing or playing a stringed instrument"" ""this as a technique or style"")",Translation?
Solfarela,"Trill, cadence",Vague? These don't really mean the same thing
...
Solfamire,"Scale, musical scale","Inferred from context - also ""range"""
Solfamifa,"To sing using the ""sol-fa"" system, solfège, vocal music",
Solfamisol,"Quaver, eighth note, sixteenth note, thirty-second note, sixty-fourth note",Vague - Should all these really be in the same word? Surely they can be said using combinations of other words
...
Solfasolmi,Prelude,
Solfasolfa,"Modulate, modulation",Translation - Changing keys?
Solfasolla,"Transpose, transposition, transposer",
Solfasolsi,Fugue,Translation - Contre-fugue?
Solfalado,"Arpeggiate, arpeggio",
Solfalare,Chord,"Inferred from context, from multiple definitions"
Solfalami,"Base, foundation, basis, fundamental, fundamentally",Base of a chord?
...
Solfasifa,Whistle,
Solfasisol,"Castanets, tambourine, cymbal",vague?
Solfasila,"Barrel organ (""A mechanical musical instrument from which predetermined music is produced by turning a handle, played, esp. in former times, by street musicians"")","Perhaps also a music player of any kind? (CD player, iPod, radio, music box, tape player, etc.?)"
Solladore,"Museum, gallery",
Solladomi,"Picture, painting, print, engraving, frame","Vague - ""frame"" doesn't seem to fit"
Solladofa,"Sketch, outline, draft",
Solladosol,"Draw, drawing, line (of a pen/pencil), drawer, cartoonist","Translation - Inferred from context. Could also be interpretted as ""design, designer, trait..."""
Solladola,"Paint, painting, painter, color, shade",
Solladosi,Miniature,
Sollaredo,Watercolor,
Sollaremi,Pastel,
Sollarefa,"Gouache, guache (A type of paint; heavy and opaque)",Necessary?
...
Sollamisi,"Relief (A type of sculpture that is partially three-dimensional, carved in a two-dimensional surface and partially extending out or sinking in)",Necessary?
Sollafado,"Daguerreotype, Daguerre (An old photographic process using iodine sensitivised silvered plates and mercury vapor)","Unnecessary - I would propose replacing this with a more modern word of a similar meaning, like recording video or something"
Sollafare,"Photograph, photograph, photographic",
Sollafami,"Reproduce, reflect, reproduction, reflection, reflectivity, reflexivity, reflector",I don't think this is 'reflect' as in a mirror's reflection - but I could be wrong. I think it is more along the lines of reproducing something and portraying its characteristics accurately
...
Sollafasi,"Conformity, identity (?), conforms, similar, same, identical, in accordance, the same as, such as, similarly, likewise",Subtle difference with Sollafala that needs extrapolation
Sollasoldo,"(to write in) Stenography, shorthand, stenographer, stenographic",
Sollasolre,"Lithography, lithographer, lithographical (a method of printing)",Archaic - Perhaps in a modern sense this could encompass all of printing?  
Sollasolmi,"Engrave, engraving, engraver",
Sollasolfa,"To chisel, engrave, chisel",Redundant w/ engrave?
Sollasolla,Compass,
...
Sollasifa,Baccalaureat - A French examination taken at 17 or 18; a person who has passed this exam,"Unnecessary and too French - maybe generally call it a ""degree"" of any kind"
...
Solsidomi,"Prose writer, prose (language in ordinary from, without metrical structure; plain or dull language), prosaic","Translation - ""Prosaiser""?"
...
Solsidosi,"Poeticize, idealize, poetry, ideality, poet, bard, poetic, perfect, ideal, poetically","Vague - I don't think ""idealize"" and the like should be here, as they are more of a metaphorical interpretation of ""poetic"""
...
Solsimido,"To soften, to become effeminate, softening, softeness, weakness, enervation, soft, weakens, effeminate",Translation - irritating? annoying?
...
Solsisoldo,"Fight against, fight, enter the fray, fight (n), moral combat, fighter, wrestler",Redundant? see Mirelafa (non-physical fight) and Fasolresol (physical fight)
...
Solsisolmi,"Popularity, popular, accredited, popularly","""Believed""?"
Solsisolfa,"Reputation, fame, repute, reputation, famous, renowned, reputed, famed","Not 'famous' like a celebrity, that is covered by Solsisolla. This is just reputation (I think, or assume)"
...
Solsilasol,"Correspond, communicate, correspondence, communication, telegram, corresponding",Telegram doesn't need to be here
...
Ladosolfa,"Spinning, spinner",Redundant?
...
Ladolare,"Wool, flannel, merino, cashmere",Lain?
Ladolami,"Sheet, draper (someone who makes cloth?)",
Ladolafa,"Silk, silk industry, silky","Taffeta, moire"
Ladolasol,"Satin, like satin",Brocade
Ladolasi,"Velvet, velvety",
Ladosido,"Fabric, cloth, material",Translation 
Ladosire,"Damask, Damascus",?
Ladosimi,"Indian, persian",
Ladosifa,"Getting closer, come closer, approach",Translation - Rapprochement
...
Laredofa,"Chestnut, blonde, red",Vague
Laredosol,"Brightness, white, whitish",
Laredola,"Buy, purchase, acquire, perchasing department, acquisition, buyer, customer","Translation - Practice? ""Pratique"""
...
Laresolsi,"Take, remove, monopolize, buy up, hoard, hoarding, monopolist, abductor",Translation - vague? mostly I think it means monopolize
Larelado,"Accounting, bookkeeping, cashier, teller, counter, box, office",
Larelare,"Count, counting, enumerate, list, account, enumeration, counter","Translation - ""Au comptant"" ""comptant en especes"""
Larelami,"Calculate, calculation, arithmetic, algebra, calculator, arithmetician, algebraic, arithmetically, algrebraically",
Larelafa,"Quantify, number, numbering, figure, numerical, numeral",Difference between this and Counting? (larelare)
Larelasol,"Combine, coordinate, combination, coordination, combined, coordinated ",Translation - Supputer?
...
Laresila,"Receipt, payed for, acquitted, received",Translation... Aquit?
...
Lamidosi,"Crush, grind, pulverize, crushing, grinding, mashing, pulverization, crushed, ground, in powder",These last six words were VERY difficult to read/decipher
Lamiredo,"Borrowing, loan, borrower",
Lamiremi,"Make credit, credit, creditor, lender, a credit account",
Lamirefa,"Pawnshop, pawnbrokers","Translation  - ""maison ou l'on prête"""
Lamiresol,"Trade, barter, swap, exchange, swapping, in exchange",Commuer?
Lamirela,"Guarantee, deposit, bail, bond, pledge",Translation - Solidarity?
...
Lamisolla,"To shrink, tighten, narrow, shrinking",Translation
...
Lamilare,"To bid, to outbid, bid more than, make a higher bid, bidding, higher prices, auction, bidder, expensive, costly, wasteful, exorbitant",Vague
Lamilami,"To double, double, duplicate, doubly",
Lamilafa,"Commodity, merchandise, goods",
Lamilasol,"Number, quantity, amount, numerous, many, multiplicity, large number, the largest number, most, in number",Vague? (Number and large number)
Lamilasi,"Employ, apply, use, utilise, consume (?), adapt, make use of, application, consumer (?), applicable, adaptable",Vague - Consumer?
...
Lafadore,Bankrupt certificate ? Concordat ? Legal settlement ?,Translation
...
Lafaredo,"Tarif, tax, rate, tax rates, normal price, fixed, unchanging, invariable, a fair price, a fixed price",Translation/vague
Lafaremi,"Mark, label, tag, price, index",
Lafarefa,"Quarter, fourth, quart",
Lafaresol,Third,
Lafarela,Half,
Lafaresi,"Complete, supplement, supplementary, entire, whole, completely, entirely, fully, thoroughly, from top to bottom, in whole, in entire",Redundant with Lamisolsi?
Lafamido,"Decline, shrinking, diminish, to go down, to lessen, smallness",
Lafamire,"Monetize, paper money, paper values",Vague?
Lafamifa,"Bill, debt, bill of exchange",Translation
Lafamisol,Minor key,(Opposite is major key)
...
Lafasolmi,"Bad manners, vulgarity, common, banal, trivial, improper, inappropriate, trivially",Translation
Lafasolfa,"Silver, silver coin, silver piece, piece of silver, argentiferous (containing silver)",
Lafasolla,Franc,Necessary? French money isn't exactly the most common
Lafasolsi,Centime,"Again, necessary?"
...
Lafalami,"Geometry, geometric, geometrical, geometrically","I think some of the ""geometry"" words ended up under proportion"
Lafalafa,Liter,
...
Lasoldola,Centi,
Lasoldosi,Deci,
Lasolredo,Piece of cloth/fabric/material,What is this word doing here?
Lasolremi,"Grow, size, big, huge, excess",Redundant?
...
Lasolrela,"Render, restore, restitution",Vague?
...
Lasolmire,"Sample, coupon, cloth",Vague
Lasolmifa,"The location of something, place",
Lasolmisol,"Bias, skew, oblique, slanting, transverse, awry, askew, aside, across, obliquely",Definition/translation?
...
Lasolfare,"Expose, flaunt, exhibit, exposition, exhibition, exhibitor, display",What's the difference between these two words? (Lasolfado & Lasolfare)
Lasolfami,"Match, set",Translation - Stock?
Lasolfasol,"Importance, important, significant, considerable",
Lasolfala,"Patent, certificate of competency, certificate of invention",Redundant
Lasolfasi,"Patent, patented",Redundant
Lasollado,"Business, businessman, business woman, business agent",Translation - Factotum?
...
Lasolsire,"Go back, take again, reclaim, reprise, resume, recapture",Translation?
...
Lasimila,"Ball of thread, (Pincushion?)",Translation
Lasimisi,Skein,This means Lasimila is probably pincushion
...
Lasisolre,"Charlatan, claim that one does something well (that one doesn't actually do well), boast, brag, boasting, bragging, charlatanry, boastful, braggart, imposter","Translation - ""Hocus pocus"", ""sleight of hand"", ""juggler"", ""showman""..."
...
Lasisolla,"Have prejudice, be detrimental to, injure, damage, wrong, detriment, disadvantage, detrimental, damaging, disadvantageous",Translation?
Lasisolsi,"Go bankrupt, bankruptcy, bankrupt",
Lasilado,"Doorkeeper, usher",Translation - exploitative?
...
Sidoremi,"Fence, border, gate, barrier",Suburbs? Translation
Sidorefa,District,
Sidoresol,"Neighborhood, area, quarter",Difference between this and Sidorefa?
Sidorela,"Opacity, opaque",
Sidoresi,"Street, sidewalk, roadway, road, pavement",
Sidomido,Square (of a city),
Sidomire,"Monument, triumphal arch, obelisk, column, pyramid",Vague; the specifics shouldn't be here
Sidomifa,"Building, edifice, castle, manor, palace",Vague; building in general or a castle?
Sidomisol,"Prefecture, town hall, prefect, sub-prefect",Vague?
Sidomila,"Town hall, mayor, deputy mayor",Translation - Vague
...
Sidosolre,"Receive money, repay, reimburse, receipt, reimbursement, repayment, refundable",Vague
Sidosolmi,"Monotony, uniformity, monotonous, uniform",
Sidosolfa,"Alley, avenue, aisle",
Sidosolla,Passage,(Corridor?)
Sidosolsi,"Corridor, hallway, maze, labyrinth",Vague - Why are maze and labyrinth here also?
Sidolado,"Suburb, suburban",
Sidolare,"Dock, lifting (?), dyke, dam",Vague
Sidolami,"River, fluvial",
Sidolafa,"Bridge, pontoon (?)",Translation?
...
Siremila,"Rule, reign, reigning, throne",Why is throne here?
...
Sirefasol,"Duke, duchess, marquis, marquise, count, countess, viscount, viscountess, baron, baroness",How to differentiate?
Sirefala,"Chivalry, knighthood, knight",
Sirefasi,"Coat of arms, blazon, escutcheon",Translation - Armorier?
...
Sirelado,"Senate, House of Peers, senator, peer",Translation - Peer??
...
Siresire,Politics,"(Political, politician, politically, &c.?)"
...
Simidofa,"Supernumerary, assistant, second-in-command, chief, boss, head (??)","Translation - Vague? ""Master, boss"" is covered by Resolredo"
Simidosol,"Secretary, secretarial work",
Simidola,"Preside, presidency, president, vice-president",Vague - Vice-president shouldn't be there
Simidosi,"Commission, comittee, committe member",
Simiredo,"Adopt, adoption, adoptive, for adoption, adoptable",
Simiremi,"Indemnify, indemnity, (compensate)",Redundant? What is the difference between Simiremi and Simirefa? Is this the non-compensatory definition of Indemnify?
...
Simifare,"Stewardship, superintendence, steward, superintendent",Translation?
Simifami,"Moderate, moderation, temperance, sobriety, frugality, temperate, sober, frugal, soberly",
Simifasol,"Manage, govern, management, governance, manager",Redundant? What is the difference between this and Simifado?
Simifala,"Receive, collection, revenue, collector, receiver",Redundant/translation/vague?
Simifasi,"Pay a salary to, reward, salary, compensation, pay",
Simisoldo,"Darkness, obscurity, dark, shadowy, darkly",To make dark?
Simisolre,"Soil (v.), tarnish, stain, dirt, spot, dirtiness, spotted, messy, dirty, unclean, dirtily",
Simisolmi,"Position, location","Redundant with Lasolmifa? Is this more along the lines of ""the circumstance of something"", ""the status""/""situation""? "
Simisolfa,"Employment, job, function, responsibility, mission, employed, employee, staff, agent",Agency?
...
Similare,"Write, put into words, writing, expression, writer","Redundant - does this have a different shade of meaning from Lamire, Soldomila, Solsidore, and Solsidomi?"
Similami,"Insert, interpose, insertion, intercalation, intercalary",
Similafa,"Article, report, statement, exposé",
Similasol,"News, news writer","Translation - also ""novelist"""
...
Sifamisi,"Be responsible for, have commission of, proxy, charge d'affaires",Vague?
Sifasoldo,"Indicate, designate, indication, designation, indicator, indicative, designative",
Sifasolre,"Traverse, cross, traversal, across",Translation - Askew?
...
Sifasimi,"Billiards, pool, ball, pool ball, skittles (a bowling game in Europe)",Vague? 
Sifasifa,"Cards, playing cards",Translation - no idea what's going on with this word
Sifasisol,"Age, antiquity, antiques, old antique, gothic, ancient, anciently, formerly, once, long ago",
Sifasila,"Chess, checkers, dominos, lotto, chip (poker?), card",Very very vague. Is this simply an irregular word in which emphasis changes the meaning entirely?
Sisoldore,"Scholarship, scholar",
Sisoldomi,"Bank, banker",
Sisoldofa,"Place (values), investment",Translation
...
Sisolredo,"Lower, drop, decrease, low",(Of the market/prices)
...
Sisolresi,"Increase, bull, high, top",(Of the market/prices)
...
Sisolmila,"Interest, the interest of",(on money)
Sisolmisi,"Usury, usurer, stockbroker",Translation - no idea here either (lending money?)
...
Sisolfasol,"To stun, daze, astound, noise, tumult, explosion, hubbub, noisy, tumultuous, deafening, tumultuously",Vague
Sisolfala,"Shock, offend, scandal, bad example, shocking, offensive, scandalous",
Sisolfasi,"Abuse, misuse, encroach upon, abuse, excess, abusive, abusively","Translation - ""Emancipation"" and ""License"""
...
Sisolsila,"Fall, collapse, crumble, capsize, subsidence, landslide, collapse","Typo - Entered as ""Sisollala"" instead of ""Sisolsila"""
...
Siladola,"Catch, trap, snare, net",lakes?
...
Silaresol,"Monopolize, monopoly, taxation (?), tax (?), tribute, contribution, taxpayer, contributory, tributary",What? Vague - what does this word actually mean?
Silarela,"Forbid, prohibit, interdiction, prohibition, forbidden, illegal, prohibited",
Silaresi,"Poach, defraud, cheat (on), poaching, smuggling, fraud, poacher, smuggler, fraudulent, fraudulently",Vague
Silamido,"Police, police officer, policeman, police sergeant",
Silamire,"Police station, police superintendent",Translation/vague
Silamifa,"""Gendarme"", armed police, constabulary",Redundant?
Silamisol,National Guard,
Silamila,"Guardhouse, post",Translation
...
Silasido,"Order of the Legion of Honor, Legionnaire, a member of the Legion of Honor",Necessary?
Silasire,"Decorate, decoration",
Silasimi,Grand Officer,Typo - Silasimi and Silasifa are switched; I entered them as they are written
Silasifa,Rank of Commander,Typo - Silasimi and Silasifa are switched; I entered them as they are written
...
Lalado,"Dawn, twilight",(Opposite meanings in one word?)
Lalare,"Day, daylight, light",
Lalami,"Meteorology, phenomenon, meteor",(maybe not necessary? At least not here?)
Lalafa,Morning,
...
Sirere,"Star, planet, comet","(Solresol doesn't lend itself toward discussing astronomy, apparantly)"
Simimi,"Moon, lunar",
Sifafa,"Sun, solar",
...
Dodomisol,"Paradise, residence of the blessed, Eden","(Accord parfait - Sens musical, dérivant de Dieu.)"
Dodomila,"Angel, cherub, archangel, seraphim, angelic, seraphic",
Dodomisi,"Perfection, completeness, fulfillment, perfect, completed, in perfection, flawless",Nota - Toute cette série musicale dérive de Die s
...
Dodofasol,"Regenerate, regeneration, regenerated",Rebirth?
Dodofala,"Apostolate, apostleship, apostle, disciple",
Dodofasi,Mission,
Dodosoldo,"Seek to convert, proselytism",
Dodosolre,"Loosen, relax, release, relaxation, releasing",Categorization? Why is this in the Religious section?
Dodosolmi,"Evangelize, gospel, Bible, New Testament, Evangelist, evangelical, evangelically","""Bible"" and ""Gospel"" and ""New Testament"" are redundant and shouldn't be in this word anyway"
...
Dodolafa,"Muhammedanism, Mohammed, Mohammedan",Muslim?
...
Dorerela,"Begging, collection, seeker, beggar",Quest? (Taking an offering?)
Doreresi,"Contribute, contribution",
Domimido,"Divine office, religious cerimoney, rite, ritual","Translation/vague? (Specifically ""Divine Office"" doesn't seem to fit)"
Domimire,Procession,
...
Dosolsolre,"Baptize, baptismal font, baptism, baptismal",Baptist?
...
Dolalasol,"Master, Choirboy ",Vague ?
...
Dosisila,"Parishioner, Book of Hours, breviary, missal",Vague?
Doredodo,"Jesuitism, Jesuit, Jesuitical",
Doremimi,"Congregation, congregational",
Dorefafa,"Canon, canonical",
Doresolsol,"Carthusian, Carthusian Monk (A monk or nun of an ""austere contemplative"" order founded by St. Bruno in 1084)",Not necessary?
...
Dofadodo,"Bigotry, hypocrisy, bigot, hypocrite",Vague - bigot and hypocrite aren't the same (hypocrite is included in another definition earlier)
...
Doladodo,"Admit, admission",Redundant w/ Dolrere?
...
Reredosol,"Stilts, stake, picket, pole, cane, spear",Categorization?
Reredola,"Build, masonry, building, mason",
Reredosi,"To build a wall, wall, partition",
Reremido,"Plaster, plasterer",
Reremire,"Limestone, quicklime, slaked lime, hydraulic lime",Translation
Reremifa,"Stone, rock, stoney, rocky",Categorization?
Reremisol,"Sand, sandblast, sand, sandy",
Reremila,"Asphalt, bitumen, bituminous",Also a verb?
Reremisi,"Petrol, petroleum, oil, naphtha",
Rerefado,"Pave, macadamize, paving, macadam, paver, paved",
Rerefare,"To tile, tile, brick",Translation - Briqueter - To lay down bricks?
...
Rerelafa,"To put a ceiling on, ceiling",Translation - also paneling?
Rerelasol,"Roof, roofing",
Rerelasi,Slate,To cover something with slates (e.g. a roof)?
Reresido,"Lightning rod, spire, pole, bar",
Reresire,Gutter,
Reresimi,"Trench, ditch, moat, basin, tank",Difference between Reresire and reresimi?
Reresifa,"Marsh, swamp, wetland, marshy, muddy, boggy",
Reresisol,"Mud, sludge, mire, silt, slime, dung, muddy, miry, slimy",
Reresila,"Sewer, drain, cesspit, sink",Translation - Gargoyle?
...
Redodosi,Greenhouse,
Remimido,"Glaze, glazing, glazier, glass, windows",(Glassmaker? Glass?
...
Refafala,"Clef, key",
Refafasi,"Bolt, safety lock",Hinge?
...
Resolsolfa,"Flatten, flattening, flat",Redundant w/ Resolsolmi?
Resolsolla,"Horizontality, horizon, horizontal, horizontally",
Resolsolsi,"Verticality, perpendicularity, vertical, perpendicular, vertically, perpendicularly",Shouldn't this be the opposite of horizontal? (I.e. Lasolsolre)
Relalado,"Cabinetmaking, cabinetmaker",Cabinet?
Relalare,"Inlay, marquetry, inlaid",
Relalami,"Surface, top, superficial, superficially",
Relalafa,"Ebony, rosewood, mahogany, walnut",Irregular?
...
Relamimi,"Side, edge, on this side, around here, in the area, in this way",Translation feels a bit vague
...
Residodo,"Equip, tool, equipped",Equipment?
...
Mimifami,"Frontal, front of, in line, abreast",Translation? Redundant w/ Mimifado?
...
Mimilasi,"At each moment, from one moment to another",Translation?
Mimisido,"Early, earlier",
Mimisire,"Very soon, in an instant (translation guess)",
Mimisimi,Now,Translation?
...
Mireremi,"No matter, nevermind, it doesn't matter, it is irrelevant",Translation?
...
Misolsolfa,"In contrast to, by contrast, however, on the other hand",Translation
Misolsolla,"Mainly, mostly, especially, above all, particularly, most of all",
Misolsolsi,Then,"Vague - how is this word used? Also ""So""?"
...
Midomimi,"About to, on the point of, on the verge of, just before","Translation ""Au moment"""
Midofafa,"Much, so much",Translation
Midosolsol,"Also, too",
Midolala,"Same, the same",
Midosisi,"In it's own way, as it pleases, in it's manner, it's own way",
Miredodo,"More, in addition, moreover, also, further",Translation - Regardless? Independently?
Miremimi,"So, so much so that, to the point that, such an extent that",
Mirefafa,"For, because",
Miresolsol,"So that, in order that",Redundant?
Mirelala,"Perhaps, possibly, maybe",
Miresisi,"Moreover, besides",Redundant?
Mifadodo,One before the other,
Mifarere,"Alternate, alternative, alternatviely, one after the other (?)",Translation?
Mifamimi,Neither one nor the other,
Mifasolsol,"In no respect, no way",
Mifalala,"Anyone, anybody, everyone, whoever",
Mifasisi,Not related (?),Translation
Misoldodo,"That is to say, for example, in other words, for instance",
Misolrere,"Early, ahead of time, early hour",Translation? Redundant w/ mimisido?
Misolmimi,"In all respects, in every respect, by every measure",
Misolfafa,"On the occasion of, about, concerning",
Misollala,"In consideration of, in comparison, given that, considering that","Translation - ""Because of"", ""on account of"""
Misolsisi,In the meantime,
Miladodo,To what extent? To what degree?,
Milarere,Well?,
Milamimi,When to take place? When was (with a sign of the past)?,Translation - not totally sure
Milafafa,When did this happen?,
Milasolsol,What do you say?,
Milasisi,What has happened? What happened? What's new?,
Misidodo,"First, firstly, primarily, first of all",Redundant?
Misirere,Who is it? Who goes there?,
Misimimi,More (such as cessation of action) (?),I don't understand the parenthetical remark
Misifafa,Alas!,
...
Fafaredo,"Prescribe, prescription",Enjoin?
...
Fafamido,"[verb form (botanise?)], Herbalism, herbalist, herbs",Translation
...
Fafamila,"Plaster, cauterize, blister",Translation ahhhh
Fafamisi,Ointment,
Fafasoldo,Pomade,Necessary?
Fafasolre,Lard,Categorization?
Fafasolmi,"To grease, to oil, grease, oil, oiliness, greasy, oily, unctuous","Translation - ""anoint"" ""fat"" ""smoothness"" ""smooth"" Also - Categorization?"
...
Fafalado,"Water down, add water to, dilute, diluting","""soak (in water)"""
Fafalare,"Left, to the left",
Fafalami,"Cook, bake, cooking, cooked","Translation - ""burn"", ""sting""...?"
...
Fafasimi,"Refine, quintessence, quintessential","Translation - ""Quintessencier"" and ""subtiliser"""
Fafasifa,"Oil (of something), aromatic oil",
Fafasisol,Lemonade,Categorization?
...
Famisisi,"Deny, negate, negation, denial",Translation (couldn't read all the words)
...
Fasimimi,"Hunchback, humpback",Translation? (Counterfeit/disguise)
...
Solsolfasi,"Epilepsy, lockjaw (tetanus) (?), epileptic",Vague (Tetanus and Epilepsy?)
Solsollado,Stone,Categorization?
Solsollare,Bladder,
Solsollami,"Genitals, urethra",
Solsollafa,"Probe, sensor, prober",
Solsollasol,Matrix,Categorization?
...
Soldodola,"Prick, sting, pierce, injection, shot, jab, piquant, biting, stinging","Translation - Is the actual meaning ""prick"" or ""inject/shot""? (probably not injection, based on Solreremi, ""inoculate"")"
...
Solmimido,"Scab, scabby",Scurf patch?
Solmimire,"Itch (v.), itch (n.), pruritus, itching, prurigo",
Solmimifa,"Scrape, scraper",Scratch? Redundant?
...
Sollalami,"Castor oil, Seidlitz water, senna",Translation/vague/irregular?
...
Solsisire,"Sewage, emptier (?)",Translation
Solsisimi,"Infect, stink, infection, stench, reek, fetidness, foul, disgusting, repulsive, apalling, stinking, fetid, rank","Translation - ""Infecter"" - Possibly ""To become disgusting etc.""? (""Infect"" means disgusting)"
Solsisifa,"Rot, rotten, corrupt, stale",
Solsisisol,"Worm, maggot, verminous",
Solsisila,"To disgust, to be repugnant, put off, sicken, gross out, disgusting",Redundant? Difference between this and Solsisimi?
Soldorere,"Fluxion, defluxion, inflammation, ophthalmia",Translation?
...
Solmifafa,"Faint, stagger, fainting, staggering, unconscious, unaware",Translation
...
Solmisisi,"Drag one's feet, loiter, mope, drag (n), dragging, loitering",Translation/categorization?
...
Lalaremi,"Subscribe, subscription, subscriber",Translation
Lalarefa,"Subscribe, subscription, subscriber",Translation (Redundant?)
...
Lalamire,"To draw (a card, lots, etc.), choose at random",Translation?
...
Lalamila,"Format, size, in folio (made of sheets of paper folded once to form two leaves), quarto (folded into four leaves (eight pages)), octavo (folded into eight leaves (sixteen pages)), duodecimo (folded into 12 leaves (24 pages)) ",Irregular
...
Lasolsolfa,"Horn, antler, horny, horned",Buffalo?
Lasolsolla,Ivory,
Lasolsolsi,Cork,
...
Lasisimi,"Sheepskin, hide","Translation - I think the other words (Chagrin and Maroquin) refer to different types of leather. In which case, I would say those shades aren't necessary to strictly define"
...
Lafarere,"Moire fabric, moire pattern",Translation
...
Lasoldodo,"[verb], grocery, grocer","Translation - Verb form ""to spice""?"
Lasolrere,"Allspice, clove, cinnamon, ginger","Irregular. Translation - ""Museade""?"
...
Sisimire,"Declare, denounce, declaration, statement, denunciation, declarer, denouncer, informer",Vague?
Sisimifa,"Affirm, attest, certify, affirmation, attestation, certificate, affirmative, certified, authentic, attested","Translation - ""Degree""/""Diploma"""
Sisimisol,"Protest, swear, oath, swearing","Translation - I think this is the idea of swearing the truth, as in court."
...
Sisifasi,"Mitigating pieces, extenuating documents",Documents that make the charged seem less guilty...
Sisisoldo,Judge,translation?
Sisisolre,Jury,
...
Sisilami,"Infamy, turpitude, enormity, atrocity, abomination, villainy, monstrosity, monster, infamous, atrocious, monstrous, horribly, monstrously",(Principally the act which is commited?)
...
Simimire,"Prosecute, prosecution, prosecutor, attorney, representative","Translation, translation. This is a guess that isn't based on much."
Simimifa,Mortgage,
...
Sifafasol,"Control, montitor, registry, controller",vague - not positive on actual meaning
...
,,
Third Part - 5-Syllable Words,,
"Key of Do - Dedicated to Animals, Plants, Minerals, Elements, and related words",,
,,
Doredoredo,Gazelle,
Doredoremi,Roe,
